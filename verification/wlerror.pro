PRO wlerror, planet
  ...
  dir='./paper/wlerror/'
  dir2='./WLresults/'
  dat=file_search(dir+planet+'/*.sav')
  ...
  FOR i=0, n-1 DO BEGIN
     ...
     photerr[i]=phot
     restore, dir2+file_basename(dat[i]) ;rms of residuals
     rat[i]=rms/phot
     dev[i]=rms
  ENDFOR

  restore, dir+'deptherr/'+planet+'.sav'
;depth error
;ad test number
;stop
  ...
  print
  print, photerr[a]
  FILE_MKDIR, dir+planet+'/err_info'
  save, filename=dir+planet+'/err_info/err_info.sav', rat, dev, photerr, a
END
