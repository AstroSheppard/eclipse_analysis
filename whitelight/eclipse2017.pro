PRO eclipse2017, month, direction, X=x, Y=y, results, user_inputs,PLOTON=plotting, CHECK=checks, INP_FILE=inp,SAVEFILE=name, SAVEDATA=savedata
...
; Have to toggle FIXTIME based on whether it can eb constrained by
; data
