PRO data_zapping, month
 
; Read in all of the files and cut them down to a window around the
; spectrum
; Using the standard zapping routine to remove any cosmic rays
; Allow the use of Cat-Zapp to test the difference between the two
; routines
...
PRO zapped, xlen, ylen, allspec, allspecnowZap, subarray
...
pro bkg, raw, size_window, output
